...
package DAGBuild.Settings is
    ...
    Default_Dark : Color_Scheme := Color_Scheme'(
		...
		Button_background                           => Hex_Color(16#ffcc66#),
		Button_foreground                           => Hex_Color(16#1f2430#),
		Button_hoverBackground                      => Hex_Color(16#fac761#),
		...
		ScrollbarSlider_background                  => Hex_Color(16#707a8c66#),
		ScrollbarSlider_hoverBackground             => Hex_Color(16#707a8c99#),
		ScrollbarSlider_activeBackground            => Hex_Color(16#707a8cb3#),
        ...
        --Editor_Background                           => Hex_Color(16#FF0000#),
    ...
    Font_Name       : String := "FiraCode-Medium.ttf";
